...
import { Bot, Code, MessageSquare, PenTool, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="pt-24 pb-12 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="pt-2 text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
            {services.map((service) => (
              <button
                ...
                className="group px-4 py-2 rounded-full bg-white/5 border border-white/10 hover:bg-primary/20 hover:border-primary/50 text-sm md:text-base text-white/80 hover:text-white relative overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-secondary/20 opacity-0 group-hover:opacity-100" />
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div>
                <div className="h-full p-8 rounded-xl border border-white/10 bg-card/30 hover:bg-card/50 flex flex-col gap-6">
                  ...
                  <div className="grid gap-4">
                    {service.categories.map((category, i) => (
                      <div
                        key={i}
                        className="p-4 rounded-lg bg-white/5 border border-white/5 hover:border-primary/30 hover:bg-white/10 group"
                      >
        ...
        <div className="mt-20 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-8">
            ...
            <Link
              to="/contact"
              className="inline-block px-10 py-4 bg-gradient-to-r from-primary to-secondary rounded-lg text-white font-bold text-xl hover:opacity-90 relative overflow-hidden group"
            >
